...
const translations = {
  ...
  open: { en: 'Open', ar: 'فتح' },
  awaitingCounterpartyApproval: { en: 'Awaiting counterparty approval', ar: 'بانتظار موافقة الطرف المقابل' },
  ...
  selfTradeLabel: { en: 'Self', ar: 'ذاتي' },
  sentTradeLabel: { en: 'Sent', ar: 'مرسلة' },
  sharedTradeLabel: { en: 'Shared', ar: 'مشتركة' },
  incomingTradeRequestsTitle: { en: 'Incoming Trade Requests', ar: 'طلبات الصفقات الواردة' },
  incomingTradeRequestsDesc: { en: 'Partner-created trades that still need your approval or cancellation decision appear here.', ar: 'تظهر هنا الصفقات التي أنشأها الشريك والتي ما زالت تحتاج موافقتك أو قرارك بشأن الإلغاء.' },
  tradeImpactExplainer: { en: 'Review the trade and agreement impact before deciding.', ar: 'راجع أثر الصفقة ونوع الاتفاق قبل اتخاذ القرار.' },
  cancellationReasonLabel: { en: 'Cancellation reason', ar: 'سبب الإلغاء' },
  cancellationReasonPlaceholder: { en: 'Explain why this approved trade should be cancelled', ar: 'اشرح لماذا يجب إلغاء هذه الصفقة المعتمدة' },
  cancellationReasonRequired: { en: 'Cancellation reason is required', ar: 'سبب الإلغاء مطلوب' },
  approveCancellationAction: { en: 'Approve Cancellation', ar: 'الموافقة على الإلغاء' },
  rejectCancellationAction: { en: 'Reject Cancellation', ar: 'رفض الإلغاء' },
  cancellationRejectedStatus: { en: 'Cancellation rejected — trade remains approved', ar: 'تم رفض الإلغاء — تبقى الصفقة معتمدة' },
  submittedPartnerTradeLocked: { en: 'Submitted partner-linked trades cannot be edited or deleted. Cancel and recreate instead.', ar: 'لا يمكن تعديل أو حذف الصفقات المرتبطة بشريك بعد إرسالها. قم بإلغائها ثم أنشئ صفقة جديدة.' },
