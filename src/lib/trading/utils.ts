...
export function getMerchantAgreementDeleteMode(agreement: MerchantAgreement, usedAgreementIds: Set<string>) {
  return usedAgreementIds.has(agreement.id) ? 'archive' as const : 'delete' as const;
}
